...
steps). The learned hash co-trains $R$ and the block representations with weight
$\lambda_h$; light pressure removes the recall catastrophe at little oracle cost.
The block-sparse matched-budget oracle (quadratic selection) is 7.9.}
\label{tab:lsh-learn}
\small
\begin{tabular}{lccc}
\toprule
...
budget. This is consistent with what scales in practice. Trained block-selection
