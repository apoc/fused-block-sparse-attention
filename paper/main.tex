...
\item A \textbf{frontier-model validation}: swapping the training-free selector into
  ...
  beats random selection $3$ to $4\times$ at matched budget; a distilled selector
  does not beat the heuristic (\Cref{sec:donor}).
\end{itemize}
...
representation tradeoff of \Cref{sec:centroid}.
